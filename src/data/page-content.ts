...
export const DEFAULT_PAGE_CONTENT: PageContent[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'about_31', key: 'timeline_1_description', label: 'Yolculuk 1 açıklaması', type: 'textarea', content: 'Akar Örme, 12 yuvarlak örme makinesiyle İstanbul’da kuruldu. Hedef: dünya standartlarında triko kumaş üretmek.', visible: true, order: 30 },
      ...
      { id: 'about_36', key: 'timeline_3_title', label: 'Yolculuk 3 başlığı', type: 'text', content: 'ISO 9001 Sertifikası', visible: true, order: 35 },
      { id: 'about_37', key: 'timeline_3_description', label: 'Yolculuk 3 açıklaması', type: 'textarea', content: 'ISO 9001 kalite yönetim belgesi alarak üretimin her aşamasında uluslararası standartları benimsedik.', visible: true, order: 36 },
      { id: 'about_38', key: 'timeline_4_year', label: 'Yolculuk 4 yılı', type: 'text', content: '2010', visible: true, order: 37 },
      { id: 'about_39', key: 'timeline_4_title', label: 'Yolculuk 4 başlığı', type: 'text', content: 'Fabrika Genişlemesi', visible: true, order: 38 },
      { id: 'about_40', key: 'timeline_4_description', label: 'Yolculuk 4 açıklaması', type: 'textarea', content: 'Boyahane, terbiye tesisi ve kalite laboratuvarı dahil 15.000 m²’lik entegre üretim tesisine taşındık.', visible: true, order: 39 },
      { id: 'about_41', key: 'timeline_5_year', label: 'Yolculuk 5 yılı', type: 'text', content: '2014', visible: true, order: 40 },
      { id: 'about_42', key: 'timeline_5_title', label: 'Yolculuk 5 başlığı', type: 'text', content: 'OEKO-TEX® Sertifikası', visible: true, order: 41 },
      { id: 'about_43', key: 'timeline_5_description', label: 'Yolculuk 5 açıklaması', type: 'textarea', content: 'OEKO-TEX® Standard 100 belgesiyle tüm kumaşlarımızın insan sağlığına uygunluğunu belgeledik.', visible: true, order: 42 },
      { id: 'about_44', key: 'timeline_6_year', label: 'Yolculuk 6 yılı', type: 'text', content: '2018', visible: true, order: 43 },
      { id: 'about_45', key: 'timeline_6_title', label: 'Yolculuk 6 başlığı', type: 'text', content: '120+ Makine', visible: true, order: 44 },
      { id: 'about_46', key: 'timeline_6_description', label: 'Yolculuk 6 açıklaması', type: 'textarea', content: 'Makine parkurumuz 120’yi aşarak 3 GG’den 28 GG’ye kadar her numara grubunda üretim kapasitesine ulaştık.', visible: true, order: 45 },
      ...
      { id: 'about_49', key: 'timeline_7_description', label: 'Yolculuk 7 açıklaması', type: 'textarea', content: 'Susuz boyama teknolojisi ve güneş enerjili üretim hatlarıyla 2030 karbon nötr hedefimize doğru ilk adımları attık.', visible: true, order: 48 },
      ...
      { id: 'about_52', key: 'timeline_8_description', label: 'Yolculuk 8 açıklaması', type: 'textarea', content: '32 ülkede 500’ü aşkın markaya hizmet veriyoruz ve triko üretiminin geleceğine yatırım yapmaya devam ediyoruz.', visible: true, order: 51 },
    ],
    updatedAt: '2026-07-20T10:00:00Z',
  },
  {
