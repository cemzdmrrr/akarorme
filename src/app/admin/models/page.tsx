    ...
    <>
      ...
      <div className="p-4 sm:p-6 space-y-4">
        ...
        <div className="rounded-xl bg-white border border-gray-200 overflow-hidden">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">Collection</th>
                  <th className="px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Season</th>
                  <th className="px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider hidden lg:table-cell">Fabric</th>
                  <th className="px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                  <th className="px-5 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Featured</th>
          ...
          {filtered.length === 0 && (
            <p className="px-5 py-12 text-center text-sm text-gray-400">No models found</p>
          )}
        </div>
      </div>
    </>
